    ...
    <div className='container'>
      <header className='header'>
        ...
        <button className='header_inputWrapper__btn'>
          <svg className='inputBtnIcon' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M7 14C10.866 14 14 10.866 14 7C14 3.13401 10.866 0 7 0C3.13401 
              ...
              fill="#B7C6E7"
            />
            <path d="M7.33331 10L10.6666 8.66671V5.33337L7.33331 6.51259V10Z" fill="#B7C6E7"/>
            <path d="M6.66669 10L3.33335 8.66671V5.33337L6.66669 6.51259V10Z" fill="#B7C6E7"/>
            <path d="M6.99998 3.33337L3.33331 4.66671L6.99998 6.00004L10.6666 4.66671L6.99998 3.33337Z" fill="#B7C6E7"/>
